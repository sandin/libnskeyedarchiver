...
TEST(KAMapTest, Ctor) {
  std::map<std::string, KAValue> map = { {"key1", KAValue("value1")}, {"key2", KAValue("value2")}, };
...
TEST(KAMapTest, Equals) {
  KAMap obj("NSDictionary", {"NSDictionary", "NSObject"}, { {"key1", KAValue("value1")}, {"key2", KAValue("value2")}, });
  
  KAMap same_class_same_content("NSDictionary", {"NSDictionary", "NSObject"}, { {"key1", KAValue("value1")}, {"key2", KAValue("value2")}, });
  ASSERT_TRUE(same_class_same_content == obj);
  
  KAMap same_class_diff_content("NSDictionary", {"NSDictionary", "NSObject"}, { {"key3", KAValue("value3")}, {"key4", KAValue("value4")}, });
  ASSERT_FALSE(same_class_diff_content == obj);
  
  KAMap diff_class_same_content("NSMutableDictionary", {"NSMutableDictionary", "NSDictionary", "NSObject"}, { {"key1", KAValue("value1")}, {"key2", KAValue("value2")}, });
